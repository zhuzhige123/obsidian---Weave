<script lang="ts" module>
  ...
  // @deprecated v5.0: 旧 UUID 标记方案已弃用，改用块文件方案
  // import { IRContentSplitter } from '../../services/incremental-reading/IRContentSplitter';
  // import { IRFileWatcher } from '../../services/incremental-reading/IRFileWatcher';
  // import { IRIncrementalSync } from '../../services/incremental-reading/IRIncrementalSync';
...
<script lang="ts">
  ...
  import { Notice, Menu, TFile } from 'obsidian';
